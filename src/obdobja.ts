...
export const OBDOBJA: Obdobje[] = [
  ...
  new Obdobje("Postimpresionizem", "", "19. stoletje", "Pariz, Francija"),
  new Obdobje("Fauvizem", "", "20. stoletje", "Pariz, Francija"),
  new Obdobje("Futurizem", "", "20. stoletje", "Pariz, Francija"),
