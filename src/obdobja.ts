...
export const OBDOBJA: Obdobje[] = [
  ...
  new Obdobje("Impresionizem", "Impresionizem je ekstremna oblika realizma. V tem obdobju so umetniki želeli naslikati vse najbolj realno možno. " +
    ...
    "bogatim in naprednim Američanom, ki so cenili to zvrst umetnosti. Za impresionizem je značilna formula umetnost = narava - človeški faktor. Slike slovenskih impresionistov imajo tudi globji pomen, za razliko od večine drugih.", "19. stoletje", "Pariz, Francija"),
  ...
  new Obdobje("Fauvizem", "V fauvizmu se uprejo vsemu realnemu (tj. realizem, impresionizem) in začnejo risati z uporabo ploskev. Čim bolj ploščato je, tem bolje je, posledično hočejo izničiti 3D efekt. Upirali so se tudi perspektivi in čustvenim poudarkom. Dedek fauvizma je Gaugin. Niso tako družbeno kritični.", "20. stoletje", "Francija"),
  ...
  new Obdobje("Kubizem", "Paul Cezanne je začetnik kubizma. Uporabljajo tri osnovna telesa, valj, stožec in pa kroglo. Barve, kompozicija, čustva, vsebina in simbolika jih ne zanima. Zanimajo jih prostor, telesnost, ne zanima simbolika. Zanima jih slikarstvo kot slikarstvo, radi slikajo tihožitja. Slikajo predmete kot bi jih videli z več strani/zornih kotov.", "20. stoletje", "Francija"),
  new Obdobje("Dadaizem", "Ime dadaizma izvira iz otroške govorice DADA. Želijo si videti svet kot otrok, tj. preko otroških oči, kot da ga vidijo popolnoma na novo. Bili so zelo proti vojni, zato so se tudi umaknili v Švico. Zbirali so se v lokalu, mislili, da je pohlep meščanov kriv za vojno. Bili so zelo kritični do družbe in meščanskega razreda. Njihove (simultane) pesmi so sestavljene samo iz nekaj besed, bolj pomemben zvok kot pomen, npr. različno recitiraš besedo (npr. vodaaaaaaa, vodavodavoda, voooOoooOooodaaaAaaa, vooooooooooda).", "20. stoletje", "lokal Cabaret Voltaire, Zürich, Švica"),
  new Obdobje("Nadrealizem ali surrealizem", "surreal = nadresnično. Takrat so začeli spoznavati psihoanalizo in po zaslugi Sigmunda Freuda so izvedeli, da je razum sestavljen iz zavednega (10%) in nezavednega dela, posledično je surrealiste izjemno zanimal nezavedni del in sanje.", "20. stoletje", "Francija"),
  ...
  new Obdobje("Abstraktni ekspresionizem", "Abstraktni ekspresionizem je prva ameriška zvrst. Načina slikanja sta action painting in pa drip painting.", "20. stoletje", "ZDA"),
